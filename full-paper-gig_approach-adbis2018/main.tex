...
\title{A Genericness, Interactivity and Guidance-based Approach for Spatio-temporal Data Applications}

% a short form should be given in case it is too long for the running head
\titlerunning{A \textit{GIG}-based Approach for Spatiotemporal Data Applications}
...
%
\authorrunning{Omidvar-Tehrani, Behrooz \textit{Et al.}}
% (feature abused for this document to repeat the title also on left hand pages)

% the affiliations are given next; don't give your e-mail address
% unless you accept that it will be published
\institute{University of Grenoble Alpes (France)\\
\mailsa\\
